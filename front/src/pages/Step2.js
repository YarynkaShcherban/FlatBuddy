        			...
        			<div style={{
						...
						<div style={{
          				...
          				<div className='main-grid'>
							...
							<div>
								<div style={{...labelStyle, marginBottom: "8px", marginTop: "14px"}}>����</div>
								<SmartBox
									fieldName="course"
									formState={formState}
									setFormState={this.setFormState}
								>
									<SmartInput placeholder="���������, 2-� ����" />
								</SmartBox>
							</div>
							...
							<div>
								<div style={{...labelStyle, marginBottom: "0px"}}>����</div>
								<div style={{
									fontSize: "12px",
									fontFamily: "Inter",
									color: "#000",
