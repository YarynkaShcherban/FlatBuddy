...
import bcrypt  # Додаємо для хешування паролів
...
# ПАРОЛЬ, ПОВТОР ПАРОЛЮ, ХЕШУВАННЯ ПАРОЛЮ
    ...
    @classmethod
    def create_user_with_password(cls, user_data, password, repeat_password):
        if password != repeat_password:
            raise ValueError("Паролі не співпадають")
        
        if len(password) < 6:
            raise ValueError("Пароль повинен містити принаймні 6 символів")
